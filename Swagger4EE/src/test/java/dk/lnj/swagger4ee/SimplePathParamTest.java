 ...
 * @author laj
 */
public class SimplePathParamTest extends AbstractJSonTest {
    ...
    public void testClass() throws Exception {
        SwaggerResource sr = new SwaggerResource() {
            ...
            public Class<?>[] getResourcesForSwagging() {
                return new Class<?>[]{SimplePathParamResource.class};
            }
        };

        SWRoot swag = sr.createSwag();

        makeCompare(swag, "src/test/resources/SimplePathParam.json");
    }
